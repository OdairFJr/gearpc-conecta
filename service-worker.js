const CACHE_NAME = 'gearpc-conecta-offline-v66-service-branch-stable';
...
const APP_SHELL = [
  ...
  './service-branch-exceptions-pilot-v64.js?v=66.0',
...
async function withRuntimeModules(response) {
  ...
  if (!html.includes('service-branch-exceptions-pilot-v64.js')) {
    html = html.replace('</body>', '  <script src="service-branch-exceptions-pilot-v64.js?v=66.0"></script>\n</body>');
  }
