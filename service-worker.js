const CACHE_NAME = 'gearpc-conecta-offline-v70-2-weekly-program-notices';
...
const APP_SHELL = [
  ...
  './programming-weekly-notices-v70.js?v=70.1',
...
async function withRuntimeModules(response) {
  ...
  if (!html.includes('programming-weekly-notices-v70.js')) {
    html = html.replace('</body>', '  <script src="programming-weekly-notices-v70.js?v=70.1"></script>\n</body>');
  }
