(() => {
  ...
  function payloadSummary(payload) {
    ...
    return `
      ...
      <section class="safety-review-section-v67"><h4>Responsáveis da atividade</h4><div class="safety-review-grid-v67"><div><strong>Coordenador</strong><br>${esc(p.coordinator || '—')}</div><div><strong>Primeiros socorros</strong><br>${esc(p.firstAidLead || '—')}</div></div></section>
      <section class="safety-review-section-v67"><div class="safety-approval-note-v67"><strong>🩹 Lembrete:</strong> conferir o kit de primeiros socorros antes da atividade.</div></section>
