      ...
      <dialog id="safetyVisitDialogV63" class="safety-dialog-v63">
        <div class="safety-dialog-shell-v63">
          ...
          <form id="safetyVisitFormV63" class="safety-form-v63">
            ...
            <section class="safety-section-v63"><h3>4. Conclusão da visita</h3><div class="safety-grid-v63"><label>Conclusão<select id="svConclusionV63"><option value="apto">✅ Local adequado</option><option value="condicional">⚠️ Adequado com providências</option><option value="nao_recomendado">❌ Não recomendado</option></select></label><label>Responsável pelo relatório<select id="svResponsibleV63"></select></label></div><label style="margin-top:10px">Providências necessárias / observações finais<textarea id="svMeasuresV63" placeholder="Ex.: isolar barranco, levar água potável, reforçar iluminação..."></textarea></label></section>
